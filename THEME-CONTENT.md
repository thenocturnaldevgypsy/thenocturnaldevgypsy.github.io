...
## ![SUBSECTION Style](https://custom-icon-badges.demolab.com/badge/-Style-24292e?logo=north-star&logoColor=white&labelColor=00416a)

| Style | Date | Commit/Issue/PR | Files | Description |
| ------------- | ------------- | ------------- | ------------- | ------------- |
| x.x.x | Updated: DD.MM.YYYY<br>Created: DD.MM.YYYY | [Commit ID](), [I#x]() [PR#x]() | - directory/filename.html<br>- directory/filename.css<br>- directory/filename.js | What was done |