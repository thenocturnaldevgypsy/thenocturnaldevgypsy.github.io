...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| 1.0.2 | 20.11.2025 | [I#10](https://github.com/thenocturnaldevgypsy/thenocturnaldevgypsy.github.io/issues/10) | chore | - Updated with the correct logo to match GitHub Profile<br>- Removed `LICENSE` as it's not needed for this project |
